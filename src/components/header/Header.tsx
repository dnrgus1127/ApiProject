...
export default function Header() {
  ...
  return (
    <div className={`fixed w-full ${visible ? "top-0" : "-top-full"} left-0 justify-between flex px-12 py-4 font-semibold items-center bg-bgColor2 z-50 duration-500  shadow-[#FFFFFF22] shadow-md`} >
      <h1
        className={`${
